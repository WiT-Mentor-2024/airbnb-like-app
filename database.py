...
)  # Функция создает объект engine, который является основным интерфейсом для взаимодействия с базой данныхб echo=True: включает вывод SQL-запросов в консоль для отладки
